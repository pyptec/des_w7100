...
extern unsigned char xdata DirIP[4];
extern unsigned char xdata SN_IP[4];
extern unsigned char xdata GW_IP[4];
/*	
********************************************************************************
...
#ifdef USE_QFN64	
//	PHY_mode_config();	// PHY setting of W7100A, this function is just for QFN 64pin package			   //richi
						// Default is "000" = auto-negotiation mode
#endif
	
	InitSerial(96); 	// Initialize serial port (Refer to serial.c)
...
{				  
	...
	uint8 xdata ip[4] = {192,168,1,230};                   	// for setting SIP register
  	uint8 xdata gw[4] = {192,168,1,1};                     	// for setting GAR register
	uint8 xdata sn[4] = {255,255,255,0};                    // for setting SUBR register			
	uint8 xdata mac[6] = {0x01,0x08,0xDC,0x11,0x22,0x16};   // for setting SHAR register
...
//	uint8 xdata txsize[MAX_SOCK_NUM] = {8,2,2,2,2,2,2,2};
//	uint8 xdata rxsize[MAX_SOCK_NUM] = {2,2,2,2,2,2,2,2};

	extern uint8 xdata str[17];
//	uint8 xdata rsn[4];
...
/*	
	...
	printf( "\r\n==========================\r\n");
	printf( "ACCESSCAN  Net Information\r\n");
	printf( "==========================\r\n");

	printf( "MAC add: %.2bx.%.2bx.%.2bx.%.2bx.%.2bx.%.2bx\r\n", 
