...
//	TI = 0; 				
 ...
 /*
		...
		TL1 = 0x8d;		// Baud Rate Setting to 9600 bps
		TH1 = 0xd0;		// Baud Rate Setting to 9600 bps

	#elif defined UART_38000

		TL1 = 0xF4;		// Baud Rate Setting to 38000 bps
		TH1 = 0xF4;		// Baud Rate Setting to 38000 bps

	#endif

 */
	if (BaudRate==115) 		// 115 200
	{
		TL1 = 0xFC;		// Baud Rate Setting to 115200bps
		TH1 = 0xFC;		// Baud Rate Setting to 115200bps
	}
	else if	(BaudRate==96)	// 9600
   	{
		TL1 = 0x8d;		// Baud Rate Setting to 9600 bps
		TH1 = 0xd0;		// Baud Rate Setting to 9600 bps

	}
	else if	(BaudRate==19) 	// 19200
   	{
		TL1 = 0xc1;		// Baud Rate Setting to 9600 bps
		TH1 = 0xe2;		// Baud Rate Setting to 9600 bps

	}
	else if (BaudRate==38) 		// 38000
   	{
		TL1 = 0xF4;		// Baud Rate Setting to 38000 bps
		TH1 = 0xF4;		// Baud Rate Setting to 38000 bps
 	}
